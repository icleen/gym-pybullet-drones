...
class CircleAviary(BaseRLAviary):
    ...
    def __init__(self,
        ...
        self.reward_poses = np.array([
            [R * np.cos((0 / NUM_WP) * (2 * np.pi) + np.pi / 2) + self.INIT_XYZS[0, 0],
             R * np.sin((0 / NUM_WP) * (2 * np.pi) + np.pi/2) - R + self.INIT_XYZS[0, 1],
             0.5
             ],

            [R * np.cos((30 / NUM_WP) * (2 * np.pi) + np.pi / 2) + self.INIT_XYZS[0, 0],
             R * np.sin((30 / NUM_WP) * (2 * np.pi) + np.pi/2) - R + self.INIT_XYZS[0, 1],
             0.5
             ],

            [R * np.cos((60 / NUM_WP) * (2 * np.pi) + np.pi / 2) + self.INIT_XYZS[0, 0],
             R * np.sin((60 / NUM_WP) * (2 * np.pi) + np.pi/2) - R + self.INIT_XYZS[0, 1],
             0.5
             ],

            [R * np.cos((90 / NUM_WP) * (2 * np.pi) + np.pi / 2) + self.INIT_XYZS[0, 0],
             R * np.sin((90 / NUM_WP) * (2 * np.pi) + np.pi/2) - R + self.INIT_XYZS[0, 1],
             0.5
             ],
             
            [R * np.cos((119 / NUM_WP) * (2 * np.pi) + np.pi / 2) + self.INIT_XYZS[0, 0],
             R * np.sin((119 / NUM_WP) * (2 * np.pi) + np.pi/2) - R + self.INIT_XYZS[0, 1],
             0.5
             ],
        ])
